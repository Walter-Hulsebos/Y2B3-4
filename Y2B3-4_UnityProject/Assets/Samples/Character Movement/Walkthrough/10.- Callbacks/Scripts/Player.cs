...
namespace EasyCharacterMovement.CharacterMovementWalkthrough.Callbacks
{
    public class Player : MonoBehaviour
    {
        ...
        private bool ColliderFilterCallback(Collider collider)
        {
            ...
            if (collider.TryGetComponent(out CharacterMotor _))
                return true;
        ...
        private CollisionBehavior CollisionBehaviorCallback(Collider collider)
        {
            ...
            // If the collider is a dynamic Rigidbody,
            // prevent using it as a moving platform (ride on) and disable step up on it (climbable step)

            Rigidbody rb = collider.attachedRigidbody;
            if (rb && !rb.isKinematic)
                collisionBehavior = CollisionBehavior.CanNotRideOn | CollisionBehavior.CanNotStepOn;
        ...
        private void OnEnable()
        {
            ...
            // Register to CharacterMovement callbacks

            CharacterMotor.colliderFilterCallback += ColliderFilterCallback;
            CharacterMotor.collisionBehaviorCallback += CollisionBehaviorCallback;
        }
        ...
        private void OnDisable()
        {
            ...
            // Unregister from CharacterMovement callbacks
